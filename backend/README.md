...
## Project Structure
    ...
    ├── employee_registrati_43283  # Django project configurations
...
1. Clone this repo and `cd employee_registrati_43283`
...
2. Clone this repo and `cd employee_registrati_43283`
